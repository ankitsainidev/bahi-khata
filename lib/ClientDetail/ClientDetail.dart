  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Column(children: [
          ...
          Text('Transactions',style: TextStyle(fontWeight: FontWeight.w200,fontSize: 20),),
          Expanded(
              child: Container(
                  decoration: BoxDecoration(boxShadow: [BoxShadow(blurRadius: 10,color: Colors.blueGrey[100])]),
